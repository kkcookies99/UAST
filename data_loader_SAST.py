...
def collate_fn(batch):
    AST_index, label = list(zip(*batch))
...
def get_dataloader(train="train"):
...
if __name__ == '__main__':
    ...
    for idx, (ast_index,  label) in tqdm(enumerate(data_loader), total=len(data_loader)):
        print('idx', idx)
